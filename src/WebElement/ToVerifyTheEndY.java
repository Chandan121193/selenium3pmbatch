...
public class ToVerifyTheEndY {
	public static void main(String[] args) {
		...
		int usernameEndY = usernameRect.getX()+usernameRect.getWidth();
		int passwordEndY = passwordRect.getX()+passwordRect.getWidth();
		
		if(usernameEndY == passwordEndY) {
